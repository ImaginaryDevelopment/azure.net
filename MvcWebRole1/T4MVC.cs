...
{
    public static MvcWebRole1.Controllers.CalcController Calc = new MvcWebRole1.Controllers.T4MVC_CalcController();
    public static MvcWebRole1.Controllers.HomeController Home = new MvcWebRole1.Controllers.T4MVC_HomeController();
...
namespace Links
{
    ...
    public static class Scripts {
        ...
        public static class Calc {
            private const string URLPATH = "~/Scripts/Calc";
            public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
            public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
            public static readonly string calc_angular_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/calc.angular.min.js") ? Url("calc.angular.min.js") : Url("calc.angular.js");
                          
            public static readonly string calc_angular2_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/calc.angular2.min.js") ? Url("calc.angular2.min.js") : Url("calc.angular2.js");
                          
            public static readonly string calc_ember_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/calc.ember.min.js") ? Url("calc.ember.min.js") : Url("calc.ember.js");
                          
            public static readonly string calc_jquery_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/calc.jquery.min.js") ? Url("calc.jquery.min.js") : Url("calc.jquery.js");
                          
            public static readonly string calc_knockout_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/calc.knockout.min.js") ? Url("calc.knockout.min.js") : Url("calc.knockout.js");
                          
            public static readonly string calc_rivets_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/calc.rivets.min.js") ? Url("calc.rivets.min.js") : Url("calc.rivets.js");
        ...
        public static readonly string knockout_preparser_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/knockout.preparser.min.js") ? Url("knockout.preparser.min.js") : Url("knockout.preparser.js");
                      
        public static readonly string modernizr_2_6_2_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/modernizr-2.6.2.min.js") ? Url("modernizr-2.6.2.min.js") : Url("modernizr-2.6.2.js");
                      
        public static readonly string rivets_js = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/rivets.min.js") ? Url("rivets.min.js") : Url("rivets.js");
                      
        public static readonly string rivets_min_js = Url("rivets.min.js");
        public static readonly string watch_min_js = Url("watch.min.js");
    }
    ...
    public static class Content {
        ...
        public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
        public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
        public static readonly string Calc_css = T4MVCHelpers.IsProduction() && T4Extensions.FileExists(URLPATH + "/Calc.min.css") ? Url("Calc.min.css") : Url("Calc.css");
        ...
        public static class themes {
            ...
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public static class gestured {
                private const string URLPATH = "~/Content/themes/gestured";
                public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                ...
                [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
                public static class images {
                    private const string URLPATH = "~/Content/themes/gestured/images";
                    public static string Url() { return T4MVCHelpers.ProcessVirtualPath(URLPATH); }
                    public static string Url(string fileName) { return T4MVCHelpers.ProcessVirtualPath(URLPATH + "/" + fileName); }
                    public static readonly string img01_jpg = Url("img01.jpg");
                    public static readonly string img02_jpg = Url("img02.jpg");
                    public static readonly string img03_jpg = Url("img03.jpg");
                }
